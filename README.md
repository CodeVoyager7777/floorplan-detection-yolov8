...
🚀 **Live Website:** [https://dev.iwayplus.in/floorplan-detection/](https://dev.iwayplus.in/floorplan-detection/)
...
* **Door Detection Dataset**: [Floor Plan Dataset on Roboflow](https://universe.roboflow.com/walldetect-f9eio/floor_plan_multiple)
* **Wall Detection Model**: [CubiCasa5k Floorplan Recognition](https://universe.roboflow.com/floorplan-recognition/cubicasa5k-2-qpmsa)
...
**Prerequisites:** This project requires **Python 3.11**.

To run this application locally, follow these steps:

1. Clone this repository to your local machine.
   ```bash
   git clone https://github.com/CodeVoyager7777/floorplan-detection-yolov8.git
    ```
...
* **Door Dataset**: [Roboflow - Floor Plan Dataset](https://universe.roboflow.com/walldetect-f9eio/floor_plan_multiple)
* **Wall Model**: [Roboflow - CubiCasa5k Floorplan Recognition](https://universe.roboflow.com/floorplan-recognition/cubicasa5k-2-qpmsa)
